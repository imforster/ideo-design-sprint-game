...
const IDEOGame = () => {
  ...
  const addCustomChallenge = () => {
    if (newChallenge.title && newChallenge.description && newChallenge.persona && newChallenge.painPoint) {
      setCustomChallenges([...customChallenges, { ...newChallenge }]);
      setNewChallenge({ title: '', description: '', persona: '', painPoint: '' });
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8 text-left">
              ...
              <div className="space-y-3">
                <div className="bg-white p-4 rounded-lg">
                  <p className="text-gray-700"><strong>Challenge:</strong> {challenge.title}</p>
                </div>
